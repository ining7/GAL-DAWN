...
void writeList(int8_t**& shortest_distance, vector<bitset<N>>& A, vector<bitset<N>>& B, int select_direction);
...
void unweightedPipeline(int n, int nodes, int8_t**& shortest_distance, vector<bitset<N>>& A, vector<bitset<N>>& B);
